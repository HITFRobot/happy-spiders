...
def code_verificate(name, passwd, file_name, code_type=1005, app_id=3510, app_key='3b54922f0469bc0fc775241b9b9d1794',
                    time_out=60):
    """
    ...
    软件开发者会有少额提成，希望大家支持本项目的发展（提成的20%会给celery项目以支持其发展）
